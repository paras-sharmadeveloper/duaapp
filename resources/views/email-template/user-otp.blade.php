                                                                            ...
                                                                            <div>
                                                                                <div
                                                                                    ...
                                                                                    <span
                                                                                        ...
                                                                                        Verification Code</span></div>
                                                                                <div></div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding:0px 20px 20px 20px; line-height:22px; text-align:inherit;"
                                                                            height="100%" valign="top"
                                                                            bgcolor="" role="module-content">
                                                                            <div>
                                                                                <div
                                                                                    ...
                                                                                    <span
                                                                                        ...
                                                                                        KahayFaqeer verification code.
                                                                                        For your security, do not share
                                                                                        this code with anyone. </span>
                                                                                </div>
                                                                                <div></div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td style="padding:0px 20px 20px 20px; line-height:22px; text-align:inherit;"
                                                                            ...
                                                                            <div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: center">
                                                                                    <span
                                                                                        style="font-size: 26px; font-family: inherit">
                                                                                        <strong>{{ $bookingData['otp'] }}</strong>
                                                                                    </span></div>
                                                                                <div></div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td style="padding:0px 20px 20px 20px; line-height:22px; text-align:inherit;"
                                                                            ...
                                                                            <div>
                                                                                <div
                                                                                    ...
                                                                                    <span
                                                                                        style="font-size: 16px; font-family: inherit">
                                                                                        Verification code is valid only

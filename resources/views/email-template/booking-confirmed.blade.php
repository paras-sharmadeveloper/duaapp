                                                    ...
                                                    <tr>
                                                        <td role="modules-container"
                                                            ...
                                                            <table class="module preheader preheader-hide"
                                                                ...
                                                                <tr>
                                                                    <td role="module-content">
                                                                        <p>Please ensure to join the meeting 15 mins
                                                                            before the set appointment time.</p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                align="center" width="100%" role="module"
                                                                data-type="columns" style="padding:30px 0px 30px 0px;"
                                                                bgcolor="#000000" data-distribution="1">
                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                                                            ...
                                                                                                            <img class="max-width"
                                                                                                                ...
                                                                                                                src="http://cdn.mcauto-images-production.sendgrid.net/4aea958326836040/c098dab5-d362-466c-adaa-c9415b9d627b/825x734.png">
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                        ...
                                                                        <td style="padding:50px 20px 10px 20px; line-height:22px; text-align:inherit;"
                                                                            ...
                                                                            <div>
                                                                                <div
                                                                                    ...
                                                                                    <span
                                                                                        style="font-size: 28px; font-family: inherit">Your
                                                                                        online dua appointment is
                                                                                        confirmed</span>
                                                                                </div>
                                                                                <div></div>
                                                                            </div>
                                                            ...
                                                            <table class="module" role="module" data-type="text"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:20px 20px 10px 20px; line-height:22px; text-align:inherit;"
                                                                            height="100%" valign="top"
                                                                            bgcolor="" role="module-content">
                                                                            <div>
                                                                                <div
                                                                                    ...
                                                                                    <span
                                                                                        style="font-family: inherit">Hi
                                                                                        {{ $dynamicData['first_name'] }},
                                                                                        your online dua appointment is
                                                                                        confirmed!</span>
                                                                                </div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: left">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    @if (!empty($dynamicData['video_conference_link']))
                                                                                        <span
                                                                                            style="font-family: inherit">You
                                                                                            can join this meeting from
                                                                                    ...
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <span
                                                                                            style="font-family: inherit"><strong>Meeting
                                                                                                duration</strong></span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <span
                                                                                            style="font-family: inherit">{{ $dynamicData['slotDuration'] }}
                                                                                            minute only</span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                    ...
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <span
                                                                                            style="font-family: inherit"><strong>Dua
                                                                                                by</strong></span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <span
                                                                                            style="font-family: inherit">{{ $dynamicData['therapist_name'] }}</span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <br>
                                                                                    ...
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <span
                                                                                            style="font-family: inherit">Name
                                                                                            :
                                                                                            {{ $dynamicData['first_name'] }}</span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <span
                                                                                            style="font-family: inherit">Email
                                                                                            :
                                                                                            {{ $dynamicData['email'] }}</span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <span
                                                                                            style="font-family: inherit">Mobile
                                                                                            :
                                                                                            {{ $dynamicData['mobile'] }}</span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <span
                                                                                            style="font-family: inherit">Country:
                                                                                            {{ $dynamicData['country'] }}</span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: inherit">
                                                                                        <br>
                                                                                    ...
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: left">
                                                                                        <span
                                                                                            style="font-family: inherit"><strong>Important
                                                                                                notes</strong></span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: left">
                                                                                        <span
                                                                                            ...
                                                                                            Please ensure to arrive at
                                                                                            the venue at least 15 mins
                                                                                            before only.</span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: left">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <span
                                                                                            ...
                                                                                            strict as there are many
                                                                                            other people who also needs
                                                                                            to be accomodated.</span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: left">
                                                                                        <br>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <span
                                                                                            ...
                                                                                            question in advance. Don't
                                                                                            discuss all background
                                                                                            stories. Your questions must
                                                                                            be within 2 lines only.
                                                                                        </span>
                                                                                    </div>
                                                                                    <div
                                                                                        style="font-family: inherit; text-align: left">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <span
                                                                                            style="color: #000000; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space-collapse: preserve; text-wrap: wrap; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline; font-family: inherit">
                                                                                            7. Men need to tell their
                                                                                            full names, and women need
                                                                                            to tell their name before
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <span
                                                                                            ...
                                                                                            Please bring a note book and
                                                                                            pen with you. In case Mr.
                                                                                            Shah advise you anything,
                                                                                            you write it at spot.</span>
                                                                                    </div>
                                                            ...
                                                            <table class="module" role="module" data-type="spacer"
                                                                border="0" cellpadding="0" cellspacing="0"
                                                                width="100%" style="table-layout: fixed;"
                                                                data-muid="10dfe38b-ab1a-4083-80ca-725cb09e3c1c">
                                                                <tbody>
                                                                    <tr>
                                                            ...
                                                            <table class="module" role="module" data-type="text"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:18px 30px 18px 40px; line-height:22px; text-align:inherit;"
                                                                            height="100%" valign="top"
                                                                            bgcolor="" role="module-content">
                                                                            <div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: center">
                                                                                    <span
                                                                                        style="font-size: 28px; font-family: inherit">Subscribe
                                                                                        Syed Sarfraz A.
                                                                                        Shah&nbsp;</span>
                                                                                </div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: center">
                                                                                    <span
                                                                                        style="font-size: 28px; font-family: inherit">Official
                                                            ...
                                                            <table class="module" role="module" data-type="divider"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:0px 30px 0px 40px;"
                                                            ...
                                                            <table class="wrapper" role="module" data-type="image"
                                                                border="0" cellpadding="0" cellspacing="0"
                                                                width="100%" style="table-layout: fixed;"
                                                                data-muid="4226a32a-c1b8-418e-8e18-9ffcbf535966">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                            ...
                                                                            <a
                                                                                href="https://www.youtube.com/u0040syed-sarfraz-a-shah-official/?sub_confirmation=1"><img
                                                                                    ...
                                                                                    data-responsive="true"
                                                                                    src="http://cdn.mcauto-images-production.sendgrid.net/4aea958326836040/8f67ef6e-2e40-4615-b3de-1ab2fbafff45/401x155.png"></a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                            <table class="module" role="module" data-type="spacer"
                                                                border="0" cellpadding="0" cellspacing="0"
                                                                width="100%" style="table-layout: fixed;"
                                                                data-muid="10dfe38b-ab1a-4083-80ca-725cb09e3c1c.1.1">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:0px 0px 30px 0px;"
                                                                            role="module-content" bgcolor="">
                                                            ...
                                                            <table class="module" role="module" data-type="text"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:18px 30px 18px 40px; line-height:28px; text-align:inherit;"
                                                                            height="100%" valign="top"
                                                                            bgcolor="" role="module-content">
                                                                            <div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: center">
                                                                                    <span style="font-size: 28px">Read
                                                                                        &amp; Listen All Books For
                                                                                        Free</span>
                                                                                </div>
                                                                                <div></div>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:18px 30px 18px 40px; line-height:22px; text-align:inherit;"
                                                                            ...
                                                                            <div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: center">
                                                                                    <span style="font-size: 18px">Be
                                                                                        kind to others and&nbsp;</span>
                                                                                </div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: center">
                                                                                    <span style="font-size: 18px">Allah
                                                                                        will be kind to you</span>
                                                                                </div>
                                                                                <div></div>
                                                                            </div>
                                                                        </td>
                                                            ...
                                                            <table class="module" role="module" data-type="text"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:30px 20px 30px 40px; line-height:22px; text-align:inherit;"
                                                                            height="100%" valign="top"
                                                                            bgcolor="" role="module-content">
                                                                            <div>
                                                                                <div

...
@section('content')
    <style>
        ...
        @media (max-width: 767px) {
            ...
            div#local-video img , #remote-video img { height: 250px;bottom: 0; }
        } 
        .action-button .btn {
            border-radius: 50%;
        }
        div#local-video img , #remote-video img { height: 485px;bottom: 0; }
    </style>
...
document.querySelector('.mute-button').addEventListener('click', () => toggleMute(room));
document.querySelector('.camera-toggle-button').addEventListener('click', () => toggleMute(room));
document.querySelector('.call-cut-button').addEventListener('click', () => toggleMute(room));

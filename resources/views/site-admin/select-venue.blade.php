    ...
    <div class="card">
        <div class="card-body">
            <div class="action d-flex justify-content-between">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <input type="number" name="" id="search" class="form-control" placeholder="search">
                    </div>
                </div>
            </div>

            @if (request()->route()->getName() == 'siteadmin.queue.show' || request()->route()->getName() == 'siteadmin.pending.show')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if(request()->route()->getName() == 'siteadmin.pending.show')
                                <a href="{{ route('siteadmin.pending.list', [$venueAdd->id]) }}"

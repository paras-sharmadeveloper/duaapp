...
@section('page-script')
    ...
    <script>
        ...
        if (accessToken && roomName) {
            console.log("yer");
            checkParticipantStatus(visitorId);
        } else {
            console.error('Access token or room name is missing.');
        }

        function checkParticipantStatus(visitorId) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // if (response.data.user_status === 'admitted') {
                    //     initializeVideoCall(token, roomName);
                    // }else if (response.data.user_status === 'in-queue') {
                    // // Participant is waiting for approval, display a message
                    // alert("you are in waiting "); 
                    //          console.log('You are waiting for host approval.');
                    // } else {
                    //     // Participant is not approved, display an error message
                    //     console.error('You are not approved to join this meeting.');
                    // }

...
return array(
    ...
    */
    ...
    'options' => array(
        ...
        "font_dir" => (env('APP_ENV') == 'local') ? public_path('assets/fonts/') : base_path('assets/fonts/'),

       // "font_dir" =>  (env('APP_ENV') == 'local') ?  public_path('assets/fonts/') : 'assets/fonts/', // Path to the directory containing Urdu font files
        /**

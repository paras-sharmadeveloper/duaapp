...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/venue/get/{id}', [VenueController::class, 'show']);
    Route::get('/venue/getall', [VenueController::class, 'index']);
    Route::post('/venue//delete', [VenueController::class, 'destroy']);
